        ...
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
              ...
              <?php foreach ($estado->estudiantes as $estudiantes): ?>
                      ...
                      <?= $this->Html->link('<i class="fa fa-eye"></i>', ['controller' => 'Estudiantes', 'action' => 'view', $estudiantes->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
                      <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'Estudiantes', 'action' => 'edit', $estudiantes->id], ['class'=>'btn btn-warning btn-xs','escape' => false]) ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">
                <i class="fa fa-share-alt"></i>
                <h3 class="box-title"><?= __('Municipios') ?></h3>
            </div>
            <div class="box-body">
              ...
              <?php foreach ($estado->municipios as $municipios): ?>
                        <tr>
                              ...
                              <td><?= h($municipios->modified) ?></td>
                                <td class="actions text-center">
                      <?= $this->Html->link('<i class="fa fa-eye"></i>', ['controller' => 'Municipios', 'action' => 'view', $municipios->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
                      <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'Municipios', 'action' => 'edit', $municipios->id], ['class'=>'btn btn-warning btn-xs','escape' => false]) ?>
