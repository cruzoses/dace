            ...
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <?= $this->Html->link('<i class="fa fa-file-excel-o"></i>',
                        ['controller' => 'archivos','action' => 'exportarEstados'],
                        ['class'=>'btn btn-box-tool','escape' => false]) 
                    ?>
                    <?= $this->Html->link('<i class="fa fa-print"></i>',
                        ['controller' => 'reportes','action' => 'listarEstados'],
                        ['class'=>'btn btn-box-tool','escape' => false]) 
                    ?>
                        ...
                        <?php foreach ($estados as $estado): ?>
                            <tr>
                                ...
                                <td class="actions text-center">
                                    ...
                                    <?= $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $estado->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
