        ...
        <div class="box box-info box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <?= $this->Html->link('<i class="fa fa-print"></i>',
                        ['controller' => 'Reportes', 'action' => 'listarSedes'], 
            ...
            <div class="box-body table-responsive no-padding">
		        <div class="oculto" id="buscar">
			        <?= $this->element('search_form', ['title' => 'Buscar Sede', 
                    ...
                    <tbody>
                        <?php foreach ($sedes as $sede): ?>
                            <tr>
                                ...
                                <td class="text-center"><?= h($sede->created) ?></td>
                                <td class="text-center"><?= h($sede->modified) ?></td>
                                <td class="actions text-center">
                                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $sede->id], ['class'=>'btn btn-warning btn-xs','escape' => false]) ?>
                                    <?= $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $sede->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
