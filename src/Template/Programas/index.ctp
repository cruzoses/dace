<?php
/**
 * @var \App\Model\Entity\Programa $programas
        ...
        <div class="box box-sace box-solid">
            ...
            <div class="box-body table-responsive no-padding">
		        <div class="oculto" id="buscar">
			        <?= $this->element('search_form', ['title' => 'Buscar Programa', 'searchFields' => $searchFields, 'filtros' => $filtros]);?>
		        </div>
                <table class="table table-bordered table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center"><?= $this->Paginator->sort('nota_minima', 'Nota Mínima') ?></th>
                    ...
                    <tbody>
                        <?php foreach ($programas as $programa): ?>
                            <tr>
                                ...
                                <td class="text-center"><?= h($programa->nota_minima) ?></td>
                                <td class="text-center"><?= $this->Number->format($programa->creditos) ?></td>
                                <td class="text-center"><?= h($programa->califica) ? 'Sí' : 'No' ?></td>
                                <td class="text-center"><?= h($programa->activo) ? 'Sí' : 'No' ?></td>
                                <td class="text-center"><?= h($programa->created) ?></td>
                                <td class="text-center"><?= h($programa->modified) ?></td>
                                <td class="actions text-center">
                                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $programa->id], ['class'=>'btn btn-warning btn-xs','escape' => false]) ?>
                                    <?= $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $programa->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
