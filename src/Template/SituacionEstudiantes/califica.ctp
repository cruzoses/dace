...
<div class="form-group">
    <label class="col-md-3 control-label">Calificación <span class="text-danger">*</span></label>
    <div class="col-md-9">
        <?php if ($tipoCalificacion == 1): ?>
...
<div class="form-group">
    <label class="col-md-3 control-label">Sección <span class="text-danger">*</span></label>
    <div class="col-md-9">
