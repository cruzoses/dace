		...
		<div class="box box-info box-solid">
        	...
        	<div class="box-body">
          		<dl class="dl-horizontal">
                    ...
                    <dd><?= h($municipio->created->format('d-m-Y g:i a')) ?></dd>
                    <dt scope="row"><?= __('Modified') ?></dt>
                    <dd><?= h($municipio->modified->format('d-m-Y g:i a')) ?></dd>
                </dl>
            </div>
            <div class="box-footer">
		        <?= $this->Html->link('<i class="fa fa-pencil"></i>&nbsp;'.__('Edit'),
			        ['action' => 'edit',$municipio->id],['class' => 'btn bg-olive btn-flat pull-left','escape' => false]); 
		        ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            <div class="box-header with-border">                
                <h3 class="box-title"><i class="fa fa-share-alt"></i>&nbsp;Parroquias</h3>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($municipio->parroquias as $parroquias): ?>
                                <tr>
                                    ...
                                    <td class="actions text-center">
                                        <?= $this->Html->link('<i class="fa fa-eye"></i>', ['controller' => 'Parroquias', 'action' => 'view', $parroquias->id], ['class'=>'btn btn-warning btn-xs','escape' => false]) ?>
                                        <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'Parroquias', 'action' => 'edit', $parroquias->id], ['class'=>'btn btn-info btn-xs','escape' => false]) ?>
                                        <?= $this->Form->postLink('<i class="fa fa-trash"></i>', ['controller' => 'Parroquias', 'action' => 'delete', $parroquias->id], ['confirm' => __('Are you sure you want to delete # {0}?', $parroquias->id), 'class'=>'btn btn-danger btn-xs','escape' => false]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
