                ...
                <table class="table table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <?php foreach ($mallas as $malla): ?>
                            ...
                            <td><?= $malla->has('programa') ? $this->Html->link($malla->programa->codename, ['controller' => 'Programas', 'action' => 'view', $malla->programa->id]) : '' ?></td>
                                <td><?= $malla->has('trayecto') ? $this->Html->link($malla->trayecto->id, ['controller' => 'Trayectos', 'action' => 'view', $malla->trayecto->id]) : '' ?></td>
                                <td><?= $malla->has('asignatura') ? $this->Html->link($malla->asignatura->codename, ['controller' => 'Asignaturas', 'action' => 'view', $malla->asignatura->id]) : '' ?></td>
                                            <td><?= h($malla->nota_minima) ?></td>
                                        <td><?= h($malla->created) ?></td>
                                        <td><?= h($malla->modified) ?></td>
