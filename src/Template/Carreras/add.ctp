        ...
        <div class="box box-primary box-solid">
            ...
            <div class="box-body">
                <?php
                    ...
                    echo $this->Form->control('mension_carrera_id', ['prepend' => '<i class="fa fa-asterisk"></i>','options' => $mensionCarreras]);
                    echo $this->Form->control('titulo_otorgado', ['prepend' => '<i class="fa fa-asterisk"></i>']);
