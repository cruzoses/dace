    ...
    <div class="col-md-12">    
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-book"></i>&nbsp;Editar Periodo</h3>
            ...
            <div class="box-body">
                <?php
                    ...
                    echo $this->Form->control('califica', ['type' => 'checkbox','label' => 'Permite Calificar']);
                    echo $this->Form->control('activo', ['type' => 'checkbox','label' => 'Activo']);
                ?>
            </div>            
