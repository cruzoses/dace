	...
	<div class="col-md-12">
		<div class="box box-info box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-info"></i>&nbsp;Periodo</h3>
        	...
        	<div class="box-body">
          		<dl class="dl-horizontal">
                    ...
                    <dd><?= $this->Number->format($periodo->nota_minima) ?></dd>
                    <dt scope="row"><?= __('Inicio') ?></dt>
                    <dd><?= h($periodo->inicio) ?></dd>
                    <dt scope="row"><?= __('Cierre') ?></dt>
                    <dd><?= h($periodo->cierre) ?></dd>
                    <dt scope="row"><?= __('Created') ?></dt>
                    <dd><?= h($periodo->created) ?></dd>
                    <dt scope="row"><?= __('Modified') ?></dt>
                    <dd><?= h($periodo->modified) ?></dd>
                    <dt scope="row"><?= __('Califica') ?></dt>
                    <dd><?= $periodo->califica ? __('Yes') : __('No'); ?></dd>
                    <dt scope="row"><?= __('Activo') ?></dt>
                    <dd><?= $periodo->activo ? __('Yes') : __('No'); ?></dd>
                </dl>
            </div>
            <div class="box-footer">
		        <?= $this->Html->link('<i class="fa fa-pencil"></i>&nbsp;'.__('Edit'),
			        ['action' => 'edit',$periodo->id],['class' => 'btn bg-olive btn-flat pull-left','escape' => false]); 
		        ?>
            ...
            <div class="box-body">
                <?php if (!empty($periodo->cursos)): ?>
                    <table class="table table-bordered table-hover table-condensed">
                        ...
                        <tbody>
                            <?php foreach ($periodo->cursos as $cursos): ?>
                                <tr>
                                    <td><?= h($cursos->id) ?></td>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <?php if (!empty($periodo->historicos)): ?>
                    <table class="table table-bordered table-hover table-condensed">
                        <thead>
                            <tr>
                                <th scope="col"><?= __('Id') ?></th>
                        ...
                        <tbody>
                            <?php foreach ($periodo->historicos as $historicos): ?>
                                <tr>
