	...
	<div class="col-md-12">
		<div class="box box-info box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-info"></i>&nbsp;Parroquia</h3>
        	...
        	<div class="box-body">
          		<dl class="dl-horizontal">
                    ...
                    <dd><?= $parroquia->has('municipio') ? $this->Html->link($parroquia->municipio->nombre, ['controller' => 'Municipios', 'action' => 'view', $parroquia->municipio->id]) : '' ?></dd>
                    <dt scope="row"><?= __('Nombre') ?></dt>
                    <dd><?= h($parroquia->nombre) ?></dd>
                    <dt scope="row"><?= __('Id') ?></dt>
                    <dd><?= $this->Number->format($parroquia->id) ?></dd>
                    <dt scope="row"><?= __('Created') ?></dt>
                    <dd><?= h($parroquia->created) ?></dd>
                    <dt scope="row"><?= __('Modified') ?></dt>
                    <dd><?= h($parroquia->modified) ?></dd>
                </dl>
            </div>
            <div class="box-footer">
		        <?= $this->Html->link('<i class="fa fa-pencil"></i>&nbsp;'.__('Edit'),
			        ['action' => 'edit',$parroquia->id],['class' => 'btn bg-olive btn-flat pull-left','escape' => false]); 
		        ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-default box-solid">
            ...
            <div class="box-body">
                <?php if (!empty($parroquia->estudiantes)): ?>
                    <table class="table table-bordered table-hover table-condensed">
                        ...
                        <tbody>
                            <?php foreach ($parroquia->estudiantes as $estudiantes): ?>
                                <tr>
