 ...
 * @method \App\Model\Entity\Subsistema|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Subsistema saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 */
class SubsistemasTable extends Table
{
    /**
     * Initialize method
     *
