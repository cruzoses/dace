...
class DepartamentosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2026-07-01 21:21:00',
                'modified' => '2026-07-01 21:21:00',
            ],
        ];
        parent::init();
    }
