...
class ParroquiasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'IX_Parroquia_Municipio' => ['type' => 'index', 'columns' => ['municipio_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'pfk_municipio_parroquia' => ['type' => 'foreign', 'columns' => ['municipio_id'], 'references' => ['municipios', 'id'], 'update' => 'noAction', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2026-06-29 23:47:59',
                'modified' => '2026-06-29 23:47:59',
            ],
        ];
        parent::init();
    }
